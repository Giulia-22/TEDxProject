...
watchnext_dataset_agg = watchnext_dataset.groupBy(col("idx").alias("idx_ref_watchnext")).agg(collect_list("url").alias("url_watchnext"), \
collect_list("watch_next_idx").alias("watch_next_idx_watchnext"))
